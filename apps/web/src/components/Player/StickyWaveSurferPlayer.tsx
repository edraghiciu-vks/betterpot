...
export const StickyWaveSurferPlayer = () => {
  ...
  const [zoomLevel, setZoomLevel] = createSignal(1) // Default zoom level (no automatic zoom)
        ...
        <div class="sticky-player__content">
          ...
          <Show when={!isMinimized()}>
            <div class="sticky-player__waveform">
              <Show when={state.currentTrack?.preview_url}>
                <WaveSurferWrapper
              ...
              <Show when={!state.currentTrack?.preview_url}>
                <div class="sticky-player__no-preview">
          ...
          <Show when={isMinimized() && wsControls()}>
